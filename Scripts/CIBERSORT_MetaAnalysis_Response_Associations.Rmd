...
# write.csv(response_meta_results,file = file.path(output_dir,"Meta_analysis_Response_PanCancer.csv"),
#            row.names = FALSE)
...
# Save and display Response results
# write.csv(response_meta_results_percancer,file = file.path(Base_dir, "Meta_analysis_Response_PerCancer2.csv"),row.names = FALSE)
