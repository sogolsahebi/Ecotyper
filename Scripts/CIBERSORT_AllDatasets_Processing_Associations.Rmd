...
| ICB_VanDenEnde  | Esophageal      | 35          | PFS/OS                   | PD-L1                               | [26359337](https://pubmed.ncbi.nlm.nih.gov/33504550/) |

### List of Datasets Used in the Analysis (Stratified by Cancer Type and Treatment)

We are using 26 datasets (data stratified by cancer type and treatment) in this analysis. Below is a table summarizing the datasets Below is a table summarizing the datasets:
...
# TODO: Note: Exclude "ICB_Prat__Lung__PD-(L)1" and "ICB_Prat__Melanoma__PD-(L)1" as they aremicroarray datasets and have NA in all rows.
...
dataset_names <- unique(combined_clin$study)[!unique(combined_clin$study) %in% c("ICB_Prat__Lung__PD-(L)1", "ICB_Prat__Melanoma__PD-(L)1")]
...
########################### warninig ##################################### 
# lack of number  response outcome:( cit off 5)
# - ICB_Auslander__Melanoma__PD-(L)1
# - ICB_Padron__Pancreas__PD-(L)1
# - ICB_Cloughesy__Brain__PD-(L)1
